...
export const ISSUE_DESCRIPTIONS: Record<string, string> = {
  ...
  ASSET_ID_DUPLICATED: 'El identificador de activo se repite dentro de la hoja',
  WRITE_OFF_DATE_MISSING: 'Activo dado de baja sin fecha de baja',
  WRITE_OFF_DATE_NOT_A_DATE: 'La fecha de baja no es una fecha',
  WRITE_OFF_BEFORE_PURCHASE: 'La fecha de baja es anterior a la de compra',
  WRITE_OFF_DATE_FUTURE: 'La fecha de baja está en el futuro',
